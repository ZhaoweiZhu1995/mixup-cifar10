...
class CIFAR10H_5K(DatasetNumerical):
    """
    """
    base_folder = 'cifar-10-h-5k'
    train_list = [
        'CIFAR10H_1.pkl',
        'CIFAR10H_2.pkl',
        'CIFAR10H_3.pkl',
    ...
    def __init__(self, root=None, file_mark="1", label_file_path=None, transform=None,
                 selected_idx=None, select_label=True, chosen_classes=None, classes_dist=None, is_mixup=False):
        assert file_mark in ["1", "2", "3", "4", "test"]
        self.file_mark = file_mark
        super(CIFAR10H_5K, self).__init__(root=root, is_train=True, label_file_path=label_file_path, transform=transform, 
    ...
    def load_data(self):
        ...
        # load from file
        if self.file_mark in ["1", "2", "3", "4"]:
            fname = f"CIFAR10H_{self.file_mark}.pkl"
